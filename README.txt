...
a persistence unit "pruebaJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaJEE/pom.xml":
...
artifact ("pruebaJEE.war") is already built. You can build
